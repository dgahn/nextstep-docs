...
class BaseBallTest {
	...
	void makePossibleBaseBallTest(final int input) {
		final var baseBall = new BaseBall(Integer.toString(input));
	...
	void makeInvalidNumberRangeBaseBallTest(final int input) {
		assertThatThrownBy(() -> new BaseBall(Integer.toString(input)))
	...
	void nothingCompareTest(final String problemString, final String answerString) {
		final var problemBall = new BaseBall(problemString);
		final var answerBall = new BaseBall(answerString);
